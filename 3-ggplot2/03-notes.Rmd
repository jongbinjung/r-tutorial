...
- To hide legends for certain `aes`thetics, use `guides()`, e.g.,
```{r, eval=FALSE}
# hide color legends
...
## Legends (cont'd)
- To specify the title/breaks/labels for a legend, use the `scale_*_` of the 
corresponding `aes`thetic, e.g.,
```{r, eval=FALSE}
