...
## Vectors: Some Exercises
- TODO: add some exercises for vector operations?
...
```{r, eval=FALSE}
name_of_function(argumetns)  # will give you the 'result'
```
...
- The answer is 1/2
- Use `R` to simulate 100,000 times and estimate the answer.
